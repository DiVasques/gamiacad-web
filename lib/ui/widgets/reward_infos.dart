...
class RewardInfos extends StatelessWidget {
  final double maxViewItemsWidth;
  const RewardInfos({super.key, required this.maxViewItemsWidth});
        ...
        return ConstrainedBox(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Gap(10),
              rewardController.selectedReward.claimersInfo.isNotEmpty
                  ? const Text(
                      '${AppTexts.claimersList}:',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                      ),
                    )
              ...
              rewardController.selectedReward.claimersInfo.isNotEmpty
                  ? Table(
                      ...
                      children: [
                        ...
                        ...rewardController.selectedReward.claimersInfo
                            .map(
                              (user) => TableRow(
                                children: [
                                  Padding(
